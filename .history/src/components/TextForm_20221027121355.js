...
export default function TextForm(props) {
    ...
    return (
        <Fragment>
            ...
            <button onClick={handleUpClick} className="button me-3">Convert to Uppercase</button>
            <button onClick={handleLowClick} className="button me-3">Convert to Lowercase</button>
            <button onClick={handleCopyClick} className="button me-3">Copy</button>
            <button onClick={handleClearClick} className="button me-3">Clear Text</button>
            <button type="submit" onClick={speak} className="button mx-2 my-2">Speak</button>
            <button type="submit" onClick={titleCase} className="button mx-2 my-2">Title Case</button>
