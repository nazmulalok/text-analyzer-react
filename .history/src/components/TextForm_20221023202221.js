...
export default function TextForm(props) {
    ...
    const toTitles = (s) => { return s.replace(/\w\S*/g, function (t) { return t.charAt(0).toUpperCase() + t.substr(1).toLowerCase(); }); }
    ...
    return (
        <>
            ...
            <button type="submit" onClick={toTitles} className="btn btn-primary mx-2 my-2">Speak</button>
