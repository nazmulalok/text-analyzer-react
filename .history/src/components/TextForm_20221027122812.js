    ...
    return (
        <Fragment>
            ...
            <div className="mb-3">
                ...
                <textarea className="form-control" placeholder='Enter Text' value={text} onChange={handleOnChange} id="my-box" rows="8" style={{ backgroundColor: props.mode === 'light' ? 'white' : '#808080bd', color: props.mode === 'light' ? 'black' : 'white' }}></textarea>
